...
geom_text(
  ...
  aes(x = Upper, 
      y = Method, 
      label = sprintf("P(C[0] > 0.47) == %.2f", Prob)),
  parse = TRUE,
  hjust = 1,
  vjust = 1.5,
  size = 9,

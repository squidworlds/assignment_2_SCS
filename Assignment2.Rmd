...
These figures can point us towards a few different distributions. We can analyse how well the data fits these distributions in the following plots.
...
The density graph of the gamma distribution across the whole population of Gamma is shown below to demonstrate fit, again with the mean, 2.5th, and 97.5th quantiles indicated in red.

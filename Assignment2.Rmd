...
```{r gamma_sex, echo = FALSE, message = FALSE, warning=FALSE, fig.width=20, fig.height=20, fig.align='center'}
...
```{r task_3, echo = FALSE, message = FALSE, warning=FALSE, fig.width=15, fig.height=15, fig.align='center'}
